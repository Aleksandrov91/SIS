namespace SIS.MvcFramework.Services
{
    ...
    public class DependencyContainer : IDependencyContainer
    {
        ...
        public void RegisterDependency<TSource, TDestination>() => this.dependencyDictionary[typeof(TSource)] = typeof(TDestination);
        ...
        public object CreateInstance(Type type)
        {
            ...
            {
                throw new InvalidOperationException($"Type of {instanceType.FullName} cannot be instantiated.");
            }
